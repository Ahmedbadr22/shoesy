...
fun CartScreen(
    ...
    Scaffold(
        ...
        Box(
            ...
            OutlinedButton(
                modifier = Modifier
                    .padding(bottom = mainScreenPaddingValues.calculateBottomPadding() - mainScreenPaddingValues.calculateBottomPadding() * 0.5f)
                    .padding(24.dp)
                    .fillMaxWidth()
                    .height(50.dp),
                onClick = {}
...
private fun CartScreenPreview() {
    ShoesyTheme {
        CartScreen(mainScreenPaddingValues = PaddingValues(), uiState = CartContract.State()) {
